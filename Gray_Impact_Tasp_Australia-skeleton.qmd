...
conducted an analysis of the epidemiological and healtcare cost impact of ... in
Australia.
...
ART and treatment as prevention on HIV among gay and bisexual men who have sex
with men (GBMSM). We used a difference equation model that incorporates the
change in the proportion diagnosed, treated, and virally suppressed as well as
the scale-up of oral HIV pre-exposure prophylaxis (PrEP) and the change in
sexual behaviour during this period. Data from national surveillance,
behavioural survey, and clinical cohorts was used to estimate model inputs.
Using the model we simulated a baseline scenario for the period validated
against available epidemiological data and a no ART increase scenario where the
proportion on ART remains at the 2011 level to assess the impact of early
initiation and treatment as prevention. We also conduced a costing analysis for
each scenario from a national health provider perspective using published HIV
healthcare cost estimates in 2019 AUD and retrospective consting scenarios
reflecting inflationary and deflationary changes in care and treatment costs
since 2009.

**Results**: **In Results section of main text so that calculated numbers can be
extracted**

**Conclusions**: Increasing the proportion of Australian GBMSM on effective ART
...
and in Australia. It underpins the UNAIDS 95-95-95 HIV cascade targets and the goal of ending
AIDS by 2030.[@unaids_danger_2022; @institute_hiv_2022;
...
costs. One study for Australia modelled the population level impact of increased
testing and treatment. [@jansson_predicting_2013] However, we are not aware of
any retrospective studies of the impact and cost effectiveness of increasing ART
in Australia following changes in guidelines to recommend earlier initiation of
ART.
