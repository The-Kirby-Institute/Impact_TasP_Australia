...
costs. For Australia, one study modelled the potential population level impact of
increased testing and treatment.[@jansson_predicting_2013] Another longitudinal
cohort study using routine health record data extracted from health services
that provide HIV diagnosis and care to gay and bisexual men (GBM) in the
Australian states of New South Wales and Victoria reported substantial
...
guidelines influenced clinician and patient decision making, meaning
...
provider perspective in Australia 2019 AUD [@lim_lifetime_2022]. The estimated
...
remains the same as it was in 2019. Since 2009 there have been substantial
changes to treatment guidelines for HIV in Australia as new drugs became
available and demonstrated superiority over older regimens in clinical trials.
\[ref
...
care and treatment over 2009-2019 increasing annually at $I_R$ and
$2 \times I_R$ and two scenarios were deflationary with the annual HIV costs
decreasing by $I_R$ and $2 \times I_R$ each year. Using the specified annual
...
and our counter-factual scenario assumed this percentage was fixed from 2011 to
2019.
...
We estimate that increasing ART use since 
...
by 2019. This results in an increase in the care and treatment costs for people
with HIV during 2009-2019 of
...
`r FormatCostDiffs("lc35", rangestr = "95% PI: ", scale = 6)` 
million AUD which more than offsets the increase in HIV healthcare
costs giving a total cost saving of
`r  FormatData((abs(costDifferencesBest$lc35) - abs(costDifferencesBest$hc_base)) / (10^6), quantile((abs(costDifferencesSims$lc35) - abs(costDifferencesSims$hc_base)) / (10^6), probs = lprob), quantile((abs(costDifferencesSims$lc35) - abs(costDifferencesSims$hc_base)) / (10^6), probs = uprob), places = 0, prefix = "$", rangestr = "95%: ")`
...
[@granich_expanding_2012;
@kahn_cost-effectiveness_2011; @long_initiating_2017; @eaton_health_2014;
@jansson_predicting_2013] In contrast we conducted a retrospective analysis
comparing the results from a baseline scenario which incorporated data on the
actual changes in prevention and treatment since 2009 to a counterfactual
scenario where the proportion of people with HIV using ART did not increase. Our
results are consistent with previous cost-effectiveness analyses of early
initiation of ART and treatment as prevention providing confirmation of those
results and show the benefits to Australia.
...
`r project$projectVars$indexYearART`
could also affect the results. Varying the time the change occurred or
incorporating the trends in this proportion prior to
`r project$projectVars$indexYearART` 
would result in
different outcomes for new infections, healthcare costs and lifetime care and
treatment costs. However, the differences with the baseline for each of these
would scale proportionally meaning there would be little change to primary
outcomes of the analyses. The main limitation is the lack of accurate
retrospective cost data for ART and how these costs changed prior to 
`r project$projectVars$indexYearART`
. We conducted a scenario analysis to cover the potential effects of changes to
treatment costs for those living with HIV over 2009-2019 and lifetime care and
treatment costs for those newly infected. Even if we take the most expensive
treatment cost scenario and the least expensive lifetime cost scenario the
increase in ART would still be cost saving or at least cost neutral (see
Figure). A more detailed and comprehensive modelling and costing analysis would
change the estimates but is unlikely to change the overall conclusion that the
increase in costs of providing care and treatment is negated by the reduction in
lifetime HIV costs.
