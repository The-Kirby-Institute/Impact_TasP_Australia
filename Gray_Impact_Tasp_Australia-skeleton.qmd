...
established could have averted a substantial number of new infections ( `r`
...
previous studies we believe this is the first analysis done for Australia. In
the majority of previous studies the results were obtained from future
projections simulated by a model or were trial based.\[refs\] In contrast we
conducted a retrospective analysis comparing the results from a baseline
scenario which incorporated data on the actual changes in prevention and
treatment since 2009 to a counterfactual scenario where the proportion of people
with HIV using ART did not increase. Our results are consistent with previous
cost-effectiveness analyses of early initiation of ART and treatment as
prevention providing confirmation of those results and show the benefits to
Australia.
...
counterfactual scenario where there was no increase in ART proportion since `r`
could also affect the results. Varying the time the change occurred or
incorporating the trends in this proportion prior to `r` would result in
...
retrospective cost data for ART and how these costs changed prior to `r` . We
conducted a scenario analysis to cover the potential effects of changes to
...
and long acting antiretroviral drugs \[refs\] which our now becoming available
will likely enhance access to ART though the overall healthcare cost
