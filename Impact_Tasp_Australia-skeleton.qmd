...
parameters and the final results \[ref Github\].
...
validationPlotCaption <- "Comparison of baseline sceanrio results to available 
data. (A) Number of people living with HIV over 2009-2019 from all simulations 
compared to estimates from the Australian HIV cascade (black discs). (B) Annual 
number of new infections over 2009-2019 from all simulations compared to 
reported notifications of HIV in MSM (excluding those previoulsy diagnosed 
overseas). "
