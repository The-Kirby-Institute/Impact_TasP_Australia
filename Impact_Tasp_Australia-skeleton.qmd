...
inflation sceanrio), so the cost of care and treatment for people living with
...
the Australian Bureau of Statistics. [@noauthor_consumer_2023]

This mean inflation rate $I_R$ was used as a base factor to define the costing
scenarios. Two of these scenarios were inflationary with the cost of HIV care
and treatment over 2009-2019 increasing annually at $I_R$ (Inflation 1 scenario)
and $2 \times I_R$ (Inflation 2 scenario) and two scenarios were deflationary
with the annual HIV costs decreasing by $I_R$ (Deflation 1 scenario) and
...
the remaining estimates used for validation.

2.  This value was calculated using Eq. @eq-incidence, the fixed input
parameters, the time-varying parameter values for the year 2009, and the initial
values of people with HIV and the number of notifications (excluding those
previously diagnosed overseas) reported in national
