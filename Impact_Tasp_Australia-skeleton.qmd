...
but less than 100%.\[@cohen_antiretroviral_2016\] We assumed $\epsilon_{ART}$
was
...
total cost and the number of packs (2011 and prior) or scripts dispensed (from 2012) of individual drugs. The change in reporting from packs to scripts 
makes it difficult to determine any trend in price over the 2009-2015 period. 
Looking at key drugs that formed part of ART regimens showed varying trends with
some remaining at a similar price while others increased or decreased over the 2009-2011 and 2012-2014 periods (see Table S2).
...
with the annual HIV costs decreasing by $I_R$ (Deflation 1 scenario) and $2
\times I_R$ (Deflation 2 scenario) each year. Using the specified annual
...
and in our counter-factual scenario we assumed this percentage was fixed
from 2011 to 2019.
...
A\$1 million. All analyses and results were generated using R version
