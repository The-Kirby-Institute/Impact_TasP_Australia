...
combinedPlotCaption <- "Summary of results from the baseline and no ART increase scenarios. (A) 
Number of people living with HIV over 2009-2019. (B) Annual number of new infections of HIV 
over 2009-2019. (C) Distribution in the total number of infections during the 2009-2019 period. 
(D) Median and 95% percentile range from across all simulations for the additional costs 
in providing ART compared to the no ART increase scenario and the reduction in lifetime care and ART costs."

validationPlotCaption <- "Comparison of baseline sceanrio results to available data. (A) Number of 
people living with HIV over 2009-2019 from all simulations compared to estimates from the 
Australian HIV cascade (black discs). (B) Annual number of new infections over 2009-2019 from all simulations compared to reported notifications of HIV in MSM (excluding those previoulsy diagnosed overseas). "
